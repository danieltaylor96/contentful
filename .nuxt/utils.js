...
export async function setContext(app, context) {
  ...
  if (!app.context) {
    app.context = {
      ...
      error: context.error,
      base: '/',
      env: {"CTF_SPACE_ID":"4m86uttlegw4","CTF_CDA_ACCESS_TOKEN":"Yeawxj3ueYOjl3mnqd0q6PJW-utV7F0Ri9au3jnBnbM","CTF_PERSON_ID":"15jwOBqpxqSAOy2eOO4S0m","CTF_BLOG_POST_TYPE_ID":"blogPost"}
    }
    // Only set once
